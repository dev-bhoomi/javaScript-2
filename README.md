...
#Text and Background Color Change with HTML, CSS, and JavaScript

This project demonstrates an interactive feature where users can change the text color and background color dynamically using HTML, CSS, and JavaScript. It provides a simple yet engaging way to customize the visual appearance of the webpage according to user preferences.
## Demo

Insert gif or link to demo

![Alt Text](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdXJxNGFxcDhneG42cTkzcXV3aHVrcWV1eTBvZDF5M3J4djhmYjcxeiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/YBwf5xyntjNQPyvMK3/source.gif)

## Deployment

[Link to Deployed Application](https://dev-bhoomi.github.io/javaScript-2/)
